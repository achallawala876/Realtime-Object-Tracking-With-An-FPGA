...
module I2C_Transmit(    
    ...
    output wire [31:0] SingleByteData,
    output wire [31:0] tempregadd,
    output wire [31:0] regadd,
    output wire [31:0] regval,
    input  wire    [4:0] okUH,
    output wire    [2:0] okHU,
    output reg [16:0]tempval,
    ...
    wire [23:0] ClkDivThreshold = 2000;  
    wire FSM_Clk, ILA_Clk;
    wire [11:0]div;
    reg clkdiv;
    
    reg [15:0] tempval2, tempval3;
...
//    assign SingleByteData = 8'b00111100;
//    reg [7:0] tempregadd = 7'b1101000;
    reg error_bit = 1'b1;      
...
//    tempval[15:0]<=0;                     
        case (State)
            ...
            STATE_INIT : begin
                 if (PC_control[0] == 1'b1) State <= 9'd1;                    
                 else begin                
                      SCL <= 1'b1;
                      SDA <= 1'b1;
                      State <= 9'd0;
